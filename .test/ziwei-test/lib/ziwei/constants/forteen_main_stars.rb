  ...
  module Constants
    module ForteenMainStars
      ...
      Places = {
        ...
        :liem_trinh => {:ty => "H", :suu => "Đ", :dan => "V", :mao => "V", :thin => "V", :ty2 => "M", :ngo => "M", :mui => "Đ", :than => "H", :dau => "H", :tuat => "H", :hoi => "H"},
        :thai_duong => {:ty => "V", :suu => "M", :dan => "V", :mao => "Đ", :thin => "M", :ty2 => "H", :ngo => "V", :mui => "M", :than => "V", :dau => "Đ", :tuat => "M", :hoi => "H"},
        :vu_khuc => {:ty => "V", :suu => "H", :dan => "M", :mao => "Đ", :thin => "H", :ty2 => "Đ", :ngo => "H", :mui => "H", :than => "M", :dau => "H", :tuat => "H", :hoi => "Đ"},
        :thien_dong => {:ty => "V", :suu => "Đ", :dan => "V", :mao => "H", :thin => "M", :ty2 => "H", :ngo => "V", :mui => "Đ", :than => "V", :dau => "H", :tuat => "M", :hoi => "H"},
