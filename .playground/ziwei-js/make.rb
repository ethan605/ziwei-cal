...
def join_js_files
  ...
  calculator_files = %w[calc_commons calc_forteen_main_stars calc_four_transformation_stars calc_normal_stars calc_other_important_stars calc_sequential_constellations calc_six_deadly_stars calc_six_lucky_stars calc_tuan_triet reuse_utils views_renderers]
  ...
  views_utils = File.read("views/views_utils.js")
...
def clean_up_and_make_copy
  ...
  `cp #{Constants::MINIFIED_FILE_NAME} build/`
  `cp views/styles.css build/ziwei.css`
  `cp -r build #{dst_dir}/ziwei-js/html`
