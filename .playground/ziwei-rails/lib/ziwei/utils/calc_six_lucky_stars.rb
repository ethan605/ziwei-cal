    ...
    module CalcSixLuckyStars
      ...
      module InstanceMethods
        ...
        def calc_ta_huu_positions(birth_month)
          ...
          ta_phu_index = thin_index.limit_inc(birth_month_number-1)
          huu_bat_index = ta_phu_index.reflect_index
        ...
        def calc_xuong_khuc_positions(birth_hour)
          ...
          van_khuc_index = thin_index.limit_inc(birth_hour_index-1)
          van_xuong_index = van_khuc_index.reflect_index
